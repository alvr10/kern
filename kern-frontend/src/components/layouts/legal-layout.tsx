...
export function LegalLayout({
  children,
  activePath,
}: LegalLayoutProps): React.JSX.Element {
  const links = [
      ...
      >
        <div className="flex w-full max-w-5xl flex-col gap-12 md:flex-row">
          ...
          <aside className="w-full shrink-0 md:w-64">
            <div className="sticky top-24">
              ...
              <nav className="flex flex-col gap-4">
                <h3 className="mb-2 text-xs font-semibold uppercase tracking-wider opacity-50">
                  Documentos Legales
                </h3>
                {links.map((link) => (
                  <Link
          ...
          <div className="max-w-3xl flex-1">
            ...
            <div
              className="mt-24 pt-8 text-xs opacity-50"
              style={{ borderTop: "1px solid rgba(128,128,128,0.2)" }}
            >
              <p>
                © 2026 KERN. Proyecto Universitario. Todos los derechos
                reservados.
              </p>
            </div>
          </div>
